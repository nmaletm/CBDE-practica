...
(
   PARTITION part1 VALUES LESS THAN (TO_DATE('01/01/2015', 'DD/MM/YYYY')),
   PARTITION part2 VALUES LESS THAN (TO_DATE('01/01/2025', 'DD/MM/YYYY')),
   PARTITION part3 VALUES LESS THAN (TO_DATE('01/01/2035', 'DD/MM/YYYY')),
