...
public class Main_normalize {
	...
	*/
	...
	private static String qu2_size = "4595";
	private static String qu2_type = "SZKJQXGPUPVMKAARTNTOVPTSTUJSUQKA";
	private static String qu2_region = "KDOCZJMUITPJGPIDVTCXWLFCSBJWMFKR";
	
	private static String qu3_segment = "NCJFKCARCCKZSBRFCEWAIVBAYWUMKEHF";
	private static String qu3_data1 = "26/09/30";
	private static String qu3_data2 = "30/01/34";

	private static String qu4_region = "AYNCNGZCKQMSMJDOABZMWLKIDGDDZZRH";
	private static String qu4_data1 = "24/02/40";
	private static String qu4_data2 = "24/02/41";
	...
	private static String QUERY1 = "SELECT l_returnflag, l_linestatus, sum(l_quantity) as sum_qty, sum(l_extendedprice) as sum_base_price, sum(l_extendedprice*(1-l_discount)) as sum_disc_price, sum(l_extendedprice*(1-l_discount)*(1+l_tax)) as sum_charge, avg(l_quantity) as avg_qty, avg(l_extendedprice) as avg_price, avg(l_discount) as avg_disc, count(*) as count_order FROM lineitem WHERE l_shipdate <= '"+qu1_data+"' GROUP BY l_returnflag, l_linestatus ORDER BY l_returnflag, l_linestatus";
	...
	private static PreparedStatement insertsLineItem(int start) throws SQLException{
		...
		PreparedStatement preparedStatement = connection.prepareStatement(selectSQL);
		for(int i = start; i < 1999+start; i++){
